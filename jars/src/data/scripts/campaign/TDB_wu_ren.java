...
public class TDB_wu_ren extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {

    @Override
    public boolean isHidden() {
        return !market.getFactionId().equals("TDB");
    }
...
//		fleet.addScript(ai);
    ...
    public String getRouteSourceId() {
        return getMarket().getId() + "_" + "TDB_wu_ren";
    }
